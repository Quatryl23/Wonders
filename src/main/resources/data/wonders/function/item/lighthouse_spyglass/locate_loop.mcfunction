...
execute if predicate {type:"minecraft:entity_scores",entity:"this",scores:{wonders.item.lighthouse_spyglass.distance:{max:{type:"minecraft:score",target:"this",score:"wonders.item.lighthouse_spyglass.min_distance"}}}} run tp @n[tag=wonders.item.lighthouse_spyglass.direction_marker] ^ ^ ^5
