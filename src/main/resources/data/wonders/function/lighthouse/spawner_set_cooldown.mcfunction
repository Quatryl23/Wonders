execute if score @s wonders.timer matches -1 if predicate {type:"minecraft:random_chance",chance:0.2} store result score @s wonders.timer run return run random value 10..100
