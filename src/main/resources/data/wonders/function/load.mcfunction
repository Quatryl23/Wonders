...
scoreboard objectives add wonders.item.mausoleum_jar.xp dummy
scoreboard objectives add wonders.item.mausoleum_jar.max_xp dummy
scoreboard objectives add wonders.item.mausoleum_jar.next_offering dummy
scoreboard objectives add wonders.item.colossus_fire.active_cooldowns dummy
scoreboard objectives add wonders.colossus.height dummy
scoreboard objectives add wonders.colossus.blocks_placed dummy
