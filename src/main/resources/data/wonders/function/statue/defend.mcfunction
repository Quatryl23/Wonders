...
execute at @s if entity @e[tag=wonders.statue.defend,distance=..200] run effect give @p[gamemode=!creative,gamemode=!spectator,distance=..25] minecraft:mining_fatigue 1 4 true
execute at @s[tag=!wonders.statue.summoned] run summon copper_golem ^2 ^-3 ^-7 {DeathLootTable:"wonders:entities/statue_copper_golem",Tags:["wonders.statue.defend","wonders.statue.defend_fire","wonders.ticked","wonders.timed"],attributes:[{id:"max_health",base:60},{id:"movement_speed",base:0.1}],active_effects:[{id:"minecraft:resistance",amplifier:4,duration:40,show_particles:0b}]}
execute at @s[tag=!wonders.statue.summoned] run summon copper_golem ^2 ^-3 ^-14 {DeathLootTable:"wonders:entities/statue_copper_golem",Tags:["wonders.statue.defend","wonders.statue.defend_damage","wonders.ticked","wonders.timed"],attributes:[{id:"max_health",base:60},{id:"movement_speed",base:0.1}],active_effects:[{id:"minecraft:resistance",amplifier:4,duration:40,show_particles:0b}]}
execute at @s[tag=!wonders.statue.summoned] run summon copper_golem ^-2 ^-3 ^-7 {DeathLootTable:"wonders:entities/statue_copper_golem",Tags:["wonders.statue.defend","wonders.statue.defend_slowness","wonders.ticked","wonders.timed"],attributes:[{id:"max_health",base:60},{id:"movement_speed",base:0.1}],active_effects:[{id:"minecraft:resistance",amplifier:4,duration:40,show_particles:0b}]}
execute at @s[tag=!wonders.statue.summoned] run summon copper_golem ^-2 ^-3 ^-14 {DeathLootTable:"wonders:entities/statue_copper_golem",Tags:["wonders.statue.defend","wonders.statue.defend_lightning","wonders.ticked","wonders.timed"],attributes:[{id:"max_health",base:60},{id:"movement_speed",base:0.1}],active_effects:[{id:"minecraft:resistance",amplifier:4,duration:40,show_particles:0b}]}
execute at @s[tag=!wonders.statue.summoned] if entity @s[tag=wonders.statue.stage_2] run summon copper_golem ^-5 ^5 ^-19 {DeathLootTable:"wonders:entities/statue_copper_golem",Tags:["wonders.statue.defend","wonders.statue.defend_slowness","wonders.ticked","wonders.timed"],attributes:[{id:"max_health",base:60},{id:"movement_speed",base:0.1}],active_effects:[{id:"minecraft:resistance",amplifier:4,duration:40,show_particles:0b}]}
execute at @s[tag=!wonders.statue.summoned] if entity @s[tag=wonders.statue.stage_3] run summon copper_golem ^5 ^5 ^-19 {DeathLootTable:"wonders:entities/statue_copper_golem",Tags:["wonders.statue.defend","wonders.statue.defend_lightning","wonders.ticked","wonders.timed"],attributes:[{id:"max_health",base:60},{id:"movement_speed",base:0.1}],active_effects:[{id:"minecraft:resistance",amplifier:4,duration:40,show_particles:0b}]}
execute at @s[tag=!wonders.statue.summoned] if entity @s[tag=wonders.statue.stage_4] run summon copper_golem ^-5 ^5 ^5 {DeathLootTable:"wonders:entities/statue_copper_golem",Tags:["wonders.statue.defend","wonders.statue.defend_fire","wonders.ticked","wonders.timed"],attributes:[{id:"max_health",base:60},{id:"movement_speed",base:0.1}],active_effects:[{id:"minecraft:resistance",amplifier:4,duration:40,show_particles:0b}]}
execute at @s[tag=!wonders.statue.summoned] if entity @s[tag=wonders.statue.stage_4] run summon copper_golem ^5 ^5 ^5 {DeathLootTable:"wonders:entities/statue_copper_golem",Tags:["wonders.statue.defend","wonders.statue.defend_damage","wonders.ticked","wonders.timed"],attributes:[{id:"max_health",base:60},{id:"movement_speed",base:0.1}],active_effects:[{id:"minecraft:resistance",amplifier:4,duration:40,show_particles:0b}]}
...
execute at @s run execute as @n[tag=wonders.statue.statue_golem] if entity @e[tag=wonders.statue.defend,distance=..100] at @s if entity @p[distance=..25.5,gamemode=!creative,gamemode=!spectator] facing entity @p[gamemode=!creative,gamemode=!spectator] eyes run function wonders:statue/pull_player

execute at @s run execute as @e[tag=wonders.statue.defend_slowness] at @s run effect give @a[distance=..3,gamemode=!spectator] slowness 1 2 true
...
execute at @s run execute as @e[tag=wonders.statue.defend_damage,scores={wonders.timer=0}] at @s run execute as @p[gamemode=!creative,gamemode=!spectator,distance=..3] run damage @s 8 magic by @n[tag=wonders.statue.defend_damage]
execute at @s run execute as @e[tag=wonders.statue.defend_fire,scores={wonders.timer=0}] at @s run execute at @p[gamemode=!creative,gamemode=!spectator,distance=..3] run fill ^ ^ ^ ^ ^ ^ fire keep
execute at @s run execute as @e[tag=wonders.statue.defend_fire,scores={wonders.timer=0}] at @s run execute as @p[gamemode=!creative,gamemode=!spectator,distance=..3] run tag @s add wonders.statue.fire
execute at @s run execute as @e[tag=wonders.statue.defend_fire,scores={wonders.timer=0}] at @s run execute as @p[gamemode=!creative,gamemode=!spectator,distance=..3] run scoreboard players set @s wonders.statue.fire_timer 100
execute at @s run execute as @e[tag=wonders.statue.defend_lightning,scores={wonders.timer=0}] at @s run execute at @p[gamemode=!creative,gamemode=!spectator,distance=..3] run summon lightning_bolt ^ ^ ^
